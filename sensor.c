...
#define WIFI_SSID "Poco1995"
#define WIFI_PASSWORD "H3nry1995"

// For the following credentials, see examples/Authentications/SignInAsUser/EmailPassword/EmailPassword.ino

/* 2. Define the API Key */
#define API_KEY "AIzaSyB-aBEYJlim5YcbLZg0hP1xSYBlPTQXZEg"

/* 3. Define the RTDB URL */
#define DATABASE_URL "iot-project-1995-default-rtdb.firebaseio.com" //<databaseName>.firebaseio.com or <databaseName>.<region>.firebasedatabase.app
...
void loop()
{
  ...
  if (Firebase.ready() && (millis() - sendDataPrevMillis > 15000 || sendDataPrevMillis == 0))
  {
    ...
    Serial.printf("Set string... %s\n", Firebase.setString(fbdo, F("/test/string"), "Hello World! henry") ? "ok" : fbdo.errorReason().c_str());
